...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { dpto_id: @equipment.dpto_id, subdpto_id: @equipment.subdpto_id, type: @equipment.type }
    end
  ...
  test "should update equipment" do
    patch :update, id: @equipment, equipment: { dpto_id: @equipment.dpto_id, subdpto_id: @equipment.subdpto_id, type: @equipment.type }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
