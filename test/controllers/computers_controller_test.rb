...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { dpto_id: @computer.dpto_id, name: @computer.name, subdpto_id: @computer.subdpto_id, type: @computer.type }
    end
  ...
  test "should update computer" do
    patch :update, id: @computer, computer: { dpto_id: @computer.dpto_id, name: @computer.name, subdpto_id: @computer.subdpto_id, type: @computer.type }
    assert_redirected_to computer_path(assigns(:computer))
  end
